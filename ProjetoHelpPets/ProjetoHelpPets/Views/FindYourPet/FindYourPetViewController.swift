...
class FindYourPetViewController: UIViewController {
    ...
    func subViewsConstraintsConfiguration() {
        ...
        NSLayoutConstraint.activate([
            ...
            findYourPetCollectionViewPets.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 15),
            findYourPetCollectionViewPets.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -15),
            findYourPetCollectionViewPets.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -10)
        ])
    }
